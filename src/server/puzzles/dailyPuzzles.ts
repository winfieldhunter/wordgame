...
export const dailyPuzzles: DailyPuzzleDef[] = [
  ...
  { date: "2026-02-25", level: "medium", hints: ["When the thing you need is hiding in plain sight.", "You've said it three different ways and they still don't get it.", "The gap between what you want and what you get."], target: "frustration" },
  { date: "2026-02-25", level: "hard", hints: ["It lives in the gap between what you want and what you get.", "The tighter you hold it, the more it grows.", "Not anger yet—the build before it."], target: "frustration" },
  ...
  { date: "2026-03-01", level: "medium", hints: ["When you know you're right but nobody's listening.", "When the thing you need is hiding in plain sight.", "The feeling of talking to a wall."], target: "frustration" },
  { date: "2026-03-01", level: "hard", hints: ["They have the answer and still don't hear you.", "The wall is not brick—it's attention.", "What grows when clarity is refused."], target: "frustration" },
