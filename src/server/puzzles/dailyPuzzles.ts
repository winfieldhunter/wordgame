...
export const dailyPuzzles: DailyPuzzleDef[] = [
  ...
  { date: "2026-02-22", level: "medium", hints: ["What's left when the last car pulls away and the door closes.", "When the house is quiet and you can finally hear yourself think.", "A feeling of calm when everyone has left."], target: "calm" },
  { date: "2026-02-22", level: "hard", hints: ["It lives in the space after the door closes.", "You notice it most when the house is empty.", "Not silence—the feeling that goes with it."], target: "serenity" },
  { date: "2026-02-23", level: "easy", hints: ["When your stomach feels wrong.", "That moment before you might get sick.", "The wobbly feeling in your gut."], target: "queasy" },
  ...
  { date: "2026-02-23", level: "hard", hints: ["The body's revolt against motion.", "Not quite sickness but the promise of it.", "What spins when you close your eyes."], target: "vertigo" },
  { date: "2026-02-24", level: "easy", hints: ["Someone who takes up a lot of space.", "They don't know when to leave.", "A person who's too much."], target: "pushy" },
  { date: "2026-02-24", level: "medium", hints: ["Someone who fills the room before they've said a word.", "They mean well but never know when to leave.", "Too much presence, too little boundary."], target: "bossy" },
  ...
  { date: "2026-02-26", level: "easy", hints: ["A smell in the air.", "What you notice after rain on hot ground.", "That earthy scent when rain first falls."], target: "scent" },
  { date: "2026-02-26", level: "medium", hints: ["The smell of rain on hot pavement.", "That first drop and the way the air changes.", "The scent of wet earth after a dry spell."], target: "aroma" },
  ...
  { date: "2026-02-27", level: "easy", hints: ["When you're out of energy.", "When your body says stop.", "Too tired to keep going."], target: "tired" },
  ...
  { date: "2026-02-27", level: "hard", hints: ["The tank is empty but the engine won't quit.", "Sleep would help if you could reach it.", "What's left when you've given everything."], target: "enervation" },
  { date: "2026-02-28", level: "easy", hints: ["When something finally makes sense.", "The look when they get it.", "When the puzzle piece fits."], target: "clarity" },
  ...
  { date: "2026-02-28", level: "hard", hints: ["Not knowledge—the moment knowledge lands.", "The face they make when the penny drops.", "What passes between two people when they align."], target: "epiphany" },
  ...
  { date: "2026-03-02", level: "easy", hints: ["Letting go of a wrong.", "Making room for someone who hurt you.", "When you choose not to hold a grudge."], target: "pardon" },
  ...
  { date: "2026-03-02", level: "hard", hints: ["You don't forget; you stop making them pay.", "The gift that costs the giver most.", "What remains when resentment leaves."], target: "absolution" },
  { date: "2026-03-03", level: "easy", hints: ["When you can't stop doing something.", "One more video, one more scroll.", "When 'one more' never means one."], target: "habit" },
  ...
  { date: "2026-03-03", level: "hard", hints: ["The brain learns to want what hurts it.", "Not habit—when habit becomes need.", "What keeps you coming back after the high fades."], target: "compulsion" },
  { date: "2026-03-04", level: "easy", hints: ["When there's no sound.", "What's left when the noise stops.", "The opposite of noise."], target: "quiet" },
  ...
  { date: "2026-03-04", level: "hard", hints: ["Not the absence of sound—the space it leaves behind.", "You notice it most when it breaks.", "What fills the room when everyone stops talking."], target: "hush" },
];
